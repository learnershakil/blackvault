              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mt-1">
                      support@blackvault.com
                    </p>
                    <p className="text-gray-600 dark:text-gray-300 mt-1">
                      sales@blackvault.com
                    </p>
                  </div>
                </div>
          ...
          <div className="lg:col-span-3">
            {submitStatus ? (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 p-8 rounded-xl shadow-sm h-full flex flex-col justify-center items-center text-center"
              >
                ...
                <button
                  ...
                  className="mt-8 px-6 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors"
                >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="mt-1 block w-full border border-gray-300 dark:border-gray-600 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring focus:ring-primary-500/30 focus:border-primary-500 dark:bg-gray-700 dark:text-white"
                    />
                  </div>
