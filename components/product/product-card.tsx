...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <div className="group relative bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-md transition-shadow overflow-hidden border border-gray-200 dark:border-gray-700">
      <Link
        ...
        <div className="relative h-64 overflow-hidden">
          ...
          {hasDiscount && (
            <motion.span
              ...
              initial="initial"
              animate="animate"
              aria-label={`Sale: ${discountPercentage}% off`}
            >
              -{discountPercentage}%
            </motion.span>
          )}
          ...
          {product.stock !== undefined && product.stock <= 0 && (
            <div className="absolute bottom-0 left-0 right-0 bg-gray-800/80 text-white text-center py-2">
              Out of Stock
            </div>
          )}
        </div>
