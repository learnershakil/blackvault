# E-commerce Platform Development Todo

## 📋 Project Setup and Configuration

- [x] **1. Project Structure & Base Configuration**

  - Set up Next.js project structure
  - Configure Tailwind CSS
  - Set up TypeScript configurations
  - Create base layouts and components folder structure

- [x] **2. Database & Authentication Setup**
  - Set up PostgreSQL database
  - Configure Prisma ORM
  - Set up NextAuth for authentication
  - Create database schema for users, products, and orders
...
- [x] **6. Shopping Cart**
  ...
  - Add persistent cart for logged-in users
